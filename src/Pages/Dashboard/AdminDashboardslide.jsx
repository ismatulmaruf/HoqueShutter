      ...
      <div className="min-h-screen bg-[#E5E5E5] py-12 px-1 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto bg-white p-2 sm:p-10 rounded-3xl shadow-2xl border border-[#333333]/10">
          <h1 className="md:text-4xl font-extrabold mb-10 text-center text-[#006973] tracking-tight border-b-2 border-[#006973] pb-4">
            Admin Portal : Home - Slide
          </h1>

          {/* Slides Section */}
          <section className="mb-12 border-b border-[#333333]/20 pb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="md:text-2xl font-bold text-[#333333]">
                Carousel Slides
              </h2>
              <button
                onClick={addSlide}
                  ...
                  {[
                    ...
                    <div key={key} className="space-y-1">
                      ...
                      <input
                        ...
                        value={slide[key]}
                        onChange={(e) =>
                          handleChange(`Slides.${i}.${key}`, e.target.value)
                        }
                        // Arabic field support
                        dir={key === "contentArabic" ? "rtl" : "ltr"}
                        className={`w-full border border-[#333333]/30 rounded-lg p-3 text-[#333333] bg-white focus:border-[#006973] focus:ring-1 focus:ring-[#006973] ${
                          key === "contentArabic" ? "text-right" : "text-left"
                        }`}
                      />
                    </div>
                  ))}
